...
Below is the currently planned stages/steps in order to complete this project.
...
# 2. Asio (C++ networking library) exploration [COMPLETED]
...
# 3. Simplified DHKE proof-of-concept build [IN PROGRESS]
...
-   Implement required number generation functionality (e.g. large prime numbers)
